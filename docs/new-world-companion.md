...
specific product returned by extension 0.1.5 is validated and cached automatically, not only the
...
quantity-verification false negatives. Extension 0.1.5 waits up to 30 seconds for client-rendered
